...
function Footer() {
  return (
    <div className="w-full h-screen font-Founders-Grotesk p-16 flex">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-9xl leading-[.7]">EYE-</h1>
          <h1 className="text-9xl leading-[.7]">OPENING</h1>
        </div>
        <div className="svg">
          <svg
            width="72"
      ...
      <div className="w-1/2">
        <h1 className="text-9xl leading-[.7]">PRESENTATIONS</h1>
